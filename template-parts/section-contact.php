...
<section id="contact" class="section section-padding contact">
    ...
    <div class="contact-content">
		<?php if ( cs_get_option( 'so_section_contact_gmap_enable' ) ): ?>
            <div id="gmap" class="" data-map-latitude="<?php echo cs_get_option( 'so_section_contact_gmap_lat' ) ?>" data-map-longitude="<?php echo cs_get_option( 'so_section_contact_gmap_long' ) ?>">
        ...
        <div class="container">
            <div class="row contact-main-content">
                ...
                <div class="col-lg-6 col-lg-push-3 col-md-8 col-md-push-2 col-sm-8 col-sm-push-2 contact-form">
                    <?php echo do_shortcode('[contact-form-7 id="21" title="Home Page Contact"]') ?>
                    <div id="form-messages"></div>
                </div>
                <!--Contact Form-->
                <!--<div class="col-lg-6 col-lg-push-3 col-md-8 col-md-push-2 col-sm-8 col-sm-push-2 contact-form">
                    <form class="ct-form" id="ct-form" method="post"
                          action="http://ebepari.com/templates/boch/mailer.php">
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-xs-12">
                                <div class="form-group">
                                    <i class="icon pe-7s-users"></i>
                                    <input name="name" id="name" required="" placeholder="Name" class="form-control"
                                           type="text">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input name="email" id="email" placeholder="Email" required="" class="form-control"
                                           type="email">
                                </div>
                            </div>
                        </div>
